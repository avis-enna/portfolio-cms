...
export function Footer({ portfolioData }: FooterProps) {
  ...
  const name = portfolioData?.personalInfo?.name || 'Portfolio Owner'
  ...
  const socialLinks = [
    ...
    {
      name: 'Website',
      url: portfolioData?.socialLinks?.website,
      icon: (
  ...
  return (
    <footer className="bg-gray-900 dark:bg-slate-950 text-white" data-testid="footer">
